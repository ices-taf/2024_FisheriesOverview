...
#~~~~~~~~~~~~~~~#
#Plot
#For Celtic Seas we have been asked to remove cod:

catch_dat2 <- catch_dat %>% filter(COMMON_NAME != "cod")
plot_catch_trends(catch_dat2, type = "COMMON_NAME", line_count = 10, plot_type = "line")
ggplot2::ggsave(paste0(year_cap, "_", ecoreg,"_FO_Catches_speciestop10_nocod.png"), path = "report/", width = 170, height = 100.5, units = "mm", dpi = 300)
