...
plot_catch_trends(catch_dat, type = "COMMON_NAME", line_count = 4, plot_type = "line")
...
#data
dat <- plot_catch_trends(catch_dat, type = "COUNTRY", line_count = 6, plot_type = "area", return_data = TRUE)
